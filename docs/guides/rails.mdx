---
title: Rails Guide
description: Generate PDFs in your Rails app with Deckle.
---
...
```ruby
# app/services/deckle.rb
require "httpx"
require "json"

class Deckle
  BASE_URL = "https://api.getdeckle.dev"

  def initialize(api_key = ENV["DECKLE_API_KEY"])
    @api_key = api_key
  end
