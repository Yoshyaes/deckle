...
<CardGroup cols={3}>
  ...
  <Card title="React → PDF" icon="react" color="#61DAFB">
    Send JSX with a default export — rendered server-side to a type-safe PDF.
  </Card>
</CardGroup>
...
- **SDKs** — TypeScript, Python, Go, and Ruby, plus a React component library and an MCP server
